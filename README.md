...
**Lớp:** 3B · **Phòng:** E403 · **Cụm:** C · **Track:** A1

| Họ và Tên | Mã Học Viên | Vai trò chính | Phần việc đảm nhiệm trong dự án |
|---|---|---|---|
|Phạm Long Nhật  |    | spec,prompt | retrieval/prompt + tiêu chí "đủ căn cứ" |
| Nguyễn Tiến Lượng |2A202602378  |prompt,code  | prototype + AI call thật,user test, feedback log, changelog  |
| Lê Thanh Tình | 2A202602449 |evidence,demo  |mining evidence, bảng đếm + mã hội thoại   |
|  |  |  |  |
